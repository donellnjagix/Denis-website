    ...
    <div id="team" className="mx-auto w-5/6 pb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-accent-black text-accent-white py-4 rounded-md w-full flex flex-col gap-2 items-center shadow-lg md:shadow-xl">
          ...
          <div className="font-bold text-xl">Andrew Phileps</div>
          <div className="text-accent-orange font-semibold">Finance Experts</div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-accent-black text-accent-white py-4 rounded-md w-full flex flex-col gap-2 items-center shadow-lg md:shadow-xl">
          ...
          <div className="font-bold text-xl">Angel july</div>
          <div className="text-accent-orange font-semibold">Finance Experts</div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-accent-black text-accent-white py-4 rounded-md w-full flex flex-col gap-2 items-center shadow-lg md:shadow-xl">
          ...
          <div className="font-bold text-xl">Herry Holand</div>
          <div className="text-accent-orange font-semibold">Finance Experts</div>
        </div>
      </div>
